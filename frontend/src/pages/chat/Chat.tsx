...
import Azure from "../../assets/logoNyrstar.png";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Talk with me</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is built to awnser Nyrstar questions</h2>
                            </Stack>
                        ) : (
